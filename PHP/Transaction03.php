...
if (empty($_REQUEST["username"]))
    ...
    $databaseHandler->badParams("NEWPASSWORD");
else
    $databaseHandler -> transactionChangePassword($_REQUEST["username"], $_REQUEST["password"], $_REQUEST["newPassword"]);
...
<form name = 'form' method='get' action='' enctype='multipart/form-data'>
    ...
    <label><span>newPassword</span>
        <input type = "text" name = "newPassword" size = "100" placeholder = "password" />
    </label>
    <label><span>&nbsp;</span>
